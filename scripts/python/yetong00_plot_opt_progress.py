...
scenario_name = "yetong03_half_sphere_traj"
scenario_folder = "data/" + scenario_name + "/"
exp_names = ["soft", "penalty", "sqp", "elm", "iegd", "ielm_sp"]

# fig1, ax1 = plt.subplots()
# plot_error_vs_constraint(ax1, scenario_folder)

fig2, axs2 = plt.subplots(2, 1, figsize=(8, 8))
plot_optimization_progress(axs2, scenario_folder, exp_names)
