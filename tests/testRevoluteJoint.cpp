...
TEST(Joint, urdf_constructor) {
  ...
  auto j1_parameters = ParametersFromSDF(*simple_urdf.JointByName("j1"));
  j1_parameters.effort_type = Joint::JointEffortType::Actuated;

  gtsam::Pose3 j1_wTj = GetJointFrame(*simple_urdf.JointByName("j1"), l1, l2);
...
TEST(Joint, sdf_constructor) {
  ...
  gtsam::Pose3 j1_wTj = GetJointFrame(*model.JointByName("joint_1"), l0, l1);
  ...
  gtsam::Pose3 j2_wTj = GetJointFrame(*model.JointByName("joint_2"), l1, l2);
...
TEST(Joint, limit_params) {
  ...
  auto j1_parameters = ParametersFromSDF(*model.JointByName("j1"));
  j1_parameters.effort_type = Joint::JointEffortType::Actuated;

  gtsam::Pose3 j1_wTj = GetJointFrame(*model.JointByName("j1"), l1, l2);
  ...
  auto joint_1_parameters = ParametersFromSDF(*model2.JointByName("joint_1"));
  joint_1_parameters.effort_type = Joint::JointEffortType::Actuated;

  gtsam::Pose3 joint_1_wTj = GetJointFrame(*model2.JointByName("joint_1"), link_0, link_1);
