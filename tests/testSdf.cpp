...
TEST(utils, load_and_parse_urdf_file) {
  ...
  auto simple_urdf = GetSdf(kUrdfPath + "/test/simple_urdf.urdf");
...
TEST(utils, load_and_parse_sdf_file) {
  auto simple_sdf = GetSdf(kSdfPath + "/test/simple.sdf");
...
TEST(utils, load_and_parse_sdf_world_file) {
  auto simple_sdf =
      GetSdf(kSdfPath + "/test/simple_rr.sdf", "simple_rr_sdf");
...
TEST(File, parameters_from_file) {
  ...
  auto spider_sdf =
      GetSdf(kSdfPath + "/test/spider.sdf", "spider");
...
TEST(Joint, limit_params) {
  ...
  auto model = GetSdf(kSdfPath + "/test/four_bar_linkage.sdf");
...
TEST(Joint, urdf_constructor_prismatic) {
  auto simple_urdf =
      GetSdf(kUrdfPath + "/test/simple_urdf_prismatic.urdf");
...
TEST(Joint, sdf_constructor_screw) {
  auto model = GetSdf(kSdfPath + "/test/simple_screw_joint.sdf",
...
TEST(Link, sdf_constructor) {
  std::string file_path = kSdfPath + "/test/simple_rr.sdf";
