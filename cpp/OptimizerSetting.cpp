...
OptimizerSetting::OptimizerSetting()
    : total_step(120),
      ...
      v_cost_model(noiseModel::Isotropic::Sigma(6, 1)),
      a_cost_model(noiseModel::Isotropic::Sigma(6, 1)),
      f_cost_model(noiseModel::Isotropic::Sigma(6, 1)),
      t_cost_model(noiseModel::Isotropic::Sigma(1, 1)),
