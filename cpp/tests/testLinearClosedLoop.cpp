...
vector<UrdfLink> urdf_5r = {
    UrdfLink(Pose3(Rot3::Rz(HALF_PI), Point3(-0.2, 0, 0)), Vector3(0, 0, 1), 'R',
              2, Pose3(Rot3(), Point3(0.4, 0, 0)), Z_3x3, true),
    UrdfLink(Pose3(Rot3::Rz(-HALF_PI), Point3(0.8, 0, 0)), Vector3(0, 0, 1), 'R',
              2.25, Pose3(Rot3(), Point3(0.45, 0, 0)), Z_3x3, false),
    UrdfLink(Pose3(Rot3::Rz(-M_PI/3), Point3(0.4, 0, 0)), Vector3(0, 0, 1), 'R',
              sqrt(3), Pose3(Rot3(), Point3(0.2*sqrt(3), 0, 0)), Z_3x3, false),
    UrdfLink(Pose3(Rot3::Rz(-HALF_PI), Point3(0.4*sqrt(3), 0, 0)), Vector3(0, 0, 1), 'R',
