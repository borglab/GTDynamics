...
vector<URDF_Link> urdf_cassie = {
    ...
    URDF_Link(Pose3(Rot3::RzRyRx(-0.068943, -0.036956, 2.7207), Point3(-0.01269, -0.03059, 0.00092)),
    ...
    URDF_Link(Pose3(Rot3::RzRyRx(0.059906, 0.0587942, 0.603695), Point3(0.11877, -0.01, 0.069)),
