...
TEST(MotionPlanner, dh_puma) {
  ...
  vector<DH_Link> dh_puma = {
      DH_Link(0, 0.0000, 0.0000, +90, 'R', 0, Point3(0, 0, 0),
              (Matrix(3, 3) << 0, 0, 0, 0, 0.35, 0, 0, 0, 0).finished(), -180, 180, 2, 0.2, 0.02,
              0.2, 0.02, 100, 5),
      DH_Link(0, 0.4318, 0, 0.0, 'R', 17.40, Point3(-0.3638, 0.006, 0.2275),
              (Matrix(3, 3) << 0.130, 0, 0, 0, 0.524, 0, 0, 0, 0.539).finished(), -180, 180, 2, 0.2,
              0.02, 0.2, 0.02, 100, 5),
      DH_Link(0, 0.0203, 0.15005, -90, 'R', 4.80,
              Point3(-0.0203, -0.0141, 0.0700),
              (Matrix(3, 3) << 0.066, 0, 0, 0, 0.086, 0, 0, 0, 0.0125).finished(), -180, 180, 2,
              0.2, 0.02, 0.2, 0.02, 100, 5),
      DH_Link(0, 0, 0.4318, +90, 'R', 0.82, Point3(-0.19, 0, 0),
              (Matrix(3, 3) << 0.0018, 0, 0, 0, 0.0013, 0, 0, 0, 0.0018).finished(), -180, 180, 2,
              0.2, 0.02, 0.2, 0.02, 100, 5),
      DH_Link(0, 0.0000, 0.0000, -90, 'R', 0.34, Point3(0, 0, 0),
              (Matrix(3, 3) << 0.0003, 0, 0, 0, 0.0004, 0, 0, 0, 0.0003).finished(), -180, 180, 2,
              0.2, 0.02, 0.2, 0.02, 100, 5),
      DH_Link(0, 0.0000, 0.0000, 0.0, 'R', 0.09, Point3(0, 0, 0.032),
              (Matrix(3, 3) << 0.00015, 0, 0, 0, 0.00015, 0, 0, 0, 0.00004).finished(), -180, 180,
