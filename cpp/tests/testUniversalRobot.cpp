...
TEST(UniversalRobot, instantiate_from_urdf_file) {
  ...
  // Initialize UniversalRobot instance from a file.
  UniversalRobot four_bar = UniversalRobot("../../../urdfs/test/four_bar_linkage.sdf");
...
TEST(UniversalRobot, removeLink) {
  // Initialize UniversalRobot instance from a file.
  std::cout << "About to load it up" << std::endl;
  UniversalRobot four_bar = UniversalRobot("../../../urdfs/test/four_bar_linkage_pure.sdf");
  std::cout << "Loaded it up" << std::endl;
  ...
  std::cout << "LOADED FOUR BAR LINKAGE" << std::endl;
}
int main() {
  TestResult tr;
