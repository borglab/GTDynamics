    ...
    UrdfLink(Pose3(Rot3(), Point3(0.43476, 0.02, 0)), Vector3(0, 0, 1), 'R',
             ...
             (Matrix(3, 3) << 0.00039238, 0.00023651, -4.987e-05, 0.00023651,
              0.013595, -4.82e-06, -4.987e-05, -4.82e-06, 0.013674)
                 .finished(),
             false),
    UrdfLink(Pose3(Rot3::RzRyRx(0, 0, 2.7207), Point3(-0.01269, -0.03059, 0)),
             ...
             (Matrix(3, 3) << 2.959e-05, 7.15e-06, -6e-07, 7.15e-06, 0.00022231,
              1e-07, -6e-07, 1e-07, 0.0002007)
                 .finished(),
             true),
    UrdfLink(Pose3(Rot3::RzRyRx(0, 0, 0.608212), Point3(0.11877, -0.01, 0)),
...
auto screw_axis =
    unit_twist(Vector3(0, 0, 1), Vector3(0.000202169, 3.86353e-05, 0.0045));
auto robot = Arm<UrdfLink>(urdf_cassie, base, tool, screw_axis, false);
