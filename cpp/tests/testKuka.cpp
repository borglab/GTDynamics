...
TEST(MotionPlanner, urdf_kuka) {
  ...
  vector<UrdfLink> kuka = {
      UrdfLink(Pose3(Rot3(), Point3(0, 0, 0.1575)), Vector3(0, 0, 1), 'R', 4,
               ...
               -2.96705972839 * 180 / M_PI, 2.96705972839 * 180 / M_PI, 10, 0.5,
               0.1),
      UrdfLink(Pose3(Rot3::RzRyRx(1.57079632679, 0, 3.14159265359),
                     Point3(0, 0, 0.2025)),
               Vector3(0, 0, 1), 'R', 4,
               Pose3(Rot3(), Point3(0.0003, 0.059, 0.042)),
               Vector3(0.05, 0.018, 0.044).asDiagonal(), true, 0, 0,
               -2.09439510239 * 180 / M_PI, 2.09439510239 * 180 / M_PI, 10, 0.5,
               0.1),
      UrdfLink(Pose3(Rot3::RzRyRx(1.57079632679, 0, 3.14159265359),
                     Point3(0, 0.2045, 0)),
      ...
      UrdfLink(Pose3(Rot3::RzRyRx(1.57079632679, 0, 0), Point3(0, 0, 0.2155)),
               Vector3(0, 0, 1), 'R', 2.7,
               Pose3(Rot3(), Point3(0, 0.067, 0.034)),
               Vector3(0.03, 0.01, 0.029).asDiagonal(), true, 0, 0,
               -2.09439510239 * 180 / M_PI, 2.09439510239 * 180 / M_PI, 10, 0.5,
               0.1),
      ...
      UrdfLink(Pose3(Rot3::RzRyRx(-1.57079632679, 3.14159265359, 0),
               ...
               -3.05432619099 * 180 / M_PI, 3.05432619099 * 180 / M_PI, 10, 0.5,
               0.1)};
