...
TEST(ForwardDynamics, gravity_x) {
  ...
  DynamicsFactorGraphInput<Vector> dynamicsInput(initialJointAngles, initialJointVelocities, known_torque,
                                                  gtsam::Vector6::Zero(),
                                                  gtsam::Vector6::Zero());
  auto factor_graph = example::robot.closedLoopForwardDynamicsFactorGraph(dynamicsInput, gravity);
  VectorValues results = factor_graph.optimize();
  auto actual_accelerations = example::robot.extractJointAcceleraions(results, example::dof);
...
/* ************************************************************************/
/**
 * Test simulation no gravity, torque at first joint
 */
...
/* ************************************************************************/
/**
 * Test simulation with gravity in x direction, torque at two joints
 */
...
/* ************************************************************************/
/**
 * Test simulation with gravity in x direction, torque at two joints, with initial velocity
 */
