...
class JRGraphBuilder:
    ...
    def step_robot_dynamics_graph(self, jr: JumpingRobot, k: int) -> NonlinearFactorGraph:
        """ Create a factor graph containing dynamcis constraints for 
            the jumping robot at a certain time step
        ...
        Returns:
            NonlinearFactorGraph: graph of dynamcis constraints
        """
    ...
    def step_source_dynamics_graph(self, jr: JumpingRobot, k: int) -> NonlinearFactorGraph:
    ...
    def step_actuator_dynamics_graph(self, jr: JumpingRobot, actuator: Actuator, k: int) -> NonlinearFactorGraph:
    ...
    def step_actuation_dynamics_graph(self, jr: JumpingRobot, k: int) -> NonlinearFactorGraph:
