...
gtdynamics::Robot getRobot() {
  gtdynamics::Robot four_bar = gtdynamics::CreateRobotFromFile(
      gtdynamics::kSdfPath + std::string("test/four_bar_linkage_pure.sdf"));
  return four_bar;
}
...
gtdynamics::Robot getRobot() {
  auto robot = gtdynamics::CreateRobotFromFile(
      gtdynamics::kUrdfPath + std::string("test/simple_urdf.urdf"));
...
gtdynamics::Robot getRobot() {
  auto robot = gtdynamics::CreateRobotFromFile(
      gtdynamics::kUrdfPath + std::string("test/simple_urdf_prismatic.urdf"));
  robot = robot.fixLink("l1");
  return robot;
}
}  // namespace simple_urdf_prismatic
...
gtdynamics::Robot getRobot() {
  auto robot = gtdynamics::CreateRobotFromFile(
      gtdynamics::kUrdfPath + std::string("test/simple_urdf_zero_inertia.urdf"));
  robot = robot.fixLink("l1");
  return robot;
}
gtsam::Vector3 gravity = gtsam::Vector3::Zero();
...
gtdynamics::Robot getRobot() {
  auto robot = gtdynamics::CreateRobotFromFile(
      gtdynamics::kUrdfPath + std::string("test/simple_urdf_eq_mass.urdf"));
  return robot;
}
gtsam::Vector3 gravity = gtsam::Vector3::Zero();
gtsam::Vector3 planar_axis(1, 0, 0);
...
gtdynamics::Robot getRobot() {
  auto robot = gtdynamics::CreateRobotFromFile(
      gtdynamics::kSdfPath + std::string("test/simple_rr.sdf"), "simple_rr_sdf");
  return robot;
}
...
gtdynamics::Robot getRobot() {
  gtdynamics::Robot jumping_robot = gtdynamics::CreateRobotFromFile(
      gtdynamics::kSdfPath + std::string("test/jumping_robot.sdf"));
