...
/**
 * @file  ScrewJoint.h
 * @brief Representation of a screw robot joint.  Revolute and Prismatic
 *  subclasses
...
/**
 * @class ScrewJoint is an implementation of the abstract Joint class
...
class ScrewJoint : public Joint {
 ...
 public:
   ...
   * TODO(gerry+stephanie): Screw joint constructor that takes in screw axis / thread pitch
   */
  ScrewJoint(const sdf::Joint &sdf_joint, JointEffortType joint_effort_type,
...
class RevoluteJoint : public ScrewJoint {
 ...
 public:
  ...
  RevoluteJoint(const sdf::Joint &sdf_joint, JointEffortType joint_effort_type,
                ...
                double accelerationLimitThreshold, double torqueLimitThreshold,
                LinkSharedPtr parent_link, LinkSharedPtr child_link)
      : ScrewJoint(sdf_joint, joint_effort_type, springCoefficient,
  ...
  RevoluteJoint(const sdf::Joint &sdf_joint, const gtdynamics::JointParams &jps,
                 LinkSharedPtr parent_link, LinkSharedPtr child_link)
      : ScrewJoint(sdf_joint, jps, parent_link, child_link) {
    setScrewAxis();
  }
...
class PrismaticJoint : public ScrewJoint {
 ...
 public:
  ...
  /** Construct joint using sdf::Joint instance and joint parameters. */
  PrismaticJoint(const sdf::Joint &sdf_joint, const gtdynamics::JointParams &jps,
                 LinkSharedPtr parent_link, LinkSharedPtr child_link)
      : ScrewJoint(sdf_joint, jps, parent_link, child_link) {
    setScrewAxis();
  }
