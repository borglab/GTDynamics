...
class GaussianProcessPriorLinear
 ...
 private:
  using This = GaussianProcessPriorLinear;
 ...
 public:
   ...
   */
  GaussianProcessPriorLinear(gtsam::Key pose_key1, gtsam::Key vel_key1,
  ...
  ~GaussianProcessPriorLinear() override {}
...
namespace gtsam {
template <>
struct traits<gtdynamics::GaussianProcessPriorLinear>
    : public Testable<gtdynamics::GaussianProcessPriorLinear> {};
}  // namespace gtsam
