...
/** PoseTwistFunctor is functor predicting link's next time step pose (COM) from previous step*/
class PoseTwistFunctor
{
...
/** EulerPoseColloFactor is a four-way nonlinear factor between link pose of current
 * and next time steps*/
class EulerPoseColloFactor
    : public gtsam::NoiseModelFactor4<gtsam::Pose3, gtsam::Pose3, gtsam::Vector6, double>
{
private:
  typedef EulerPoseColloFactor This;
  typedef gtsam::NoiseModelFactor4<gtsam::Pose3, gtsam::Pose3, gtsam::Vector6, double> Base;

  PoseTwistFunctor predict_;
...
public:
  ...
  */
      ...
      boost::optional<gtsam::Matrix &> H_dt = boost::none) const override
  {
    ...
    auto pose_j_hat = predict_(pose_i, twistdt, H_pose_i, H_twistdt);
...
/** TrapezoidalPoseColloFactor is a five-way nonlinear factor between link pose of current
 * and next time steps*/
class TrapezoidalPoseColloFactor
    : public gtsam::NoiseModelFactor5<gtsam::Pose3, gtsam::Pose3, gtsam::Vector6, gtsam::Vector6, double>
{
private:
  typedef TrapezoidalPoseColloFactor This;
  typedef gtsam::NoiseModelFactor5<gtsam::Pose3, gtsam::Pose3, gtsam::Vector6, gtsam::Vector6, double> Base;

  PoseTwistFunctor predict_;

public:
  TrapezoidalPoseColloFactor(gtsam::Key pose_key_i, gtsam::Key pose_key_j,
                             gtsam::Key twist_i_key, gtsam::Key twist_j_key,
                             gtsam::Key dt_key,
                             const gtsam::noiseModel::Base::shared_ptr &cost_model)
      : Base(cost_model, pose_key_i, pose_key_j, twist_i_key, twist_j_key, dt_key),
        predict_(PoseTwistFunctor()) {}
...
/** EulerTwistColloFactor is a four-way nonlinear factor between link twist of current
 * and next time steps*/
class EulerTwistColloFactor
    : public gtsam::NoiseModelFactor4<gtsam::Vector6, gtsam::Vector6, gtsam::Vector6, double>
{
private:
  typedef EulerTwistColloFactor This;
  typedef gtsam::NoiseModelFactor4<gtsam::Vector6, gtsam::Vector6, gtsam::Vector6, double> Base;

public:
  EulerTwistColloFactor(gtsam::Key twist_key_i, gtsam::Key twist_key_j, gtsam::Key accel_key, gtsam::Key dt_key,
                        const gtsam::noiseModel::Base::shared_ptr &cost_model)
...
/** TrapezoidalTwistColloFactor is a four-way nonlinear factor between link twist of current
 * and next time steps*/
class TrapezoidalTwistColloFactor
    : public gtsam::NoiseModelFactor5<gtsam::Vector6, gtsam::Vector6, gtsam::Vector6, gtsam::Vector6, double>
{
private:
  typedef TrapezoidalTwistColloFactor This;
  typedef gtsam::NoiseModelFactor5<gtsam::Vector6, gtsam::Vector6, gtsam::Vector6, gtsam::Vector6, double> Base;

public:
  TrapezoidalTwistColloFactor(gtsam::Key twist_key_i, gtsam::Key twist_key_j,
                              gtsam::Key accel_key_i, gtsam::Key accel_key_j,
                              gtsam::Key dt_key,
                              const gtsam::noiseModel::Base::shared_ptr &cost_model)
      : Base(cost_model, twist_key_i, twist_key_j, accel_key_i, accel_key_j, dt_key) {}
